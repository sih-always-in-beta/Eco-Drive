...
import com.always_in_beta.ecodrive.model.User;
...
//        Text Input Layouts
    ...
    private void signUp(final String name, final String email, final String phone, String pass) {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            AsyncTask.execute(new Runnable() {
                                @Override
                                public void run() {
                                    User user = new User(mAuth.getUid(), name, phone, email);
                                    db.document("Users/" + mAuth.getUid()).set(user);
                                }
                            });
